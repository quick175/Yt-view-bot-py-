this program requires yt-dlp.exe which is NOT my program and you can download it from https://github.com/yt-dlp/yt-dlp
...
Note-Default browser for taskill func is set to opera 
